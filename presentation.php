	...
	<section id="services" class="section section-padded">
		<div class="container">
			<div class="row text-center title">
				<h2>Je me caractérise par...</h2>
				<h4 class="light muted">Définissez vos points forts, vos compétences, et soyez unique!</h4>
			</div>
			<div class="row services">
				<div class="col-md-4">
                                    <div class="service" style="background-color: #a6e1ec;">
						<div class="icon-holder">
							<img src="img/icons/weight-blue.png" alt="" class="icon">
						</div>
                                            <h4 class="heading">Mes compétences</h4>
						<p class="description">Les compétences de la bdd.</p>
					</div>
				</div>
				<div class="col-md-4">
					<div class="service" style="background-color: #a6e1ec;">
						...
						<h4 class="heading">Mes projets Réalisés</h4>
						<p class="description">Les projets réaliés de la bdd.</p>
					</div>
				</div>
				<div class="col-md-4" >
					<div class="service" style="background-color: #a6e1ec;">
						...
						<h4 class="heading">Je m'y connais aussi</h4>
						<p class="description">Les extra de la bdd.</p>
					</div>
				</div>
			</div>
		</div>
